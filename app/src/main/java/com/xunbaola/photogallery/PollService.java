...
public class PollService extends IntentService {
    ...
    public static final String ACTION_SHOW_NOTIFICATION="com.xunbaola.photogallery.SHOW_NOTIFICATION";
    public static final String PERM_PRIVATE="com.xunbaola.photogallery.PRIVATE";
    /**
     ...
     */
    public PollService() {
        super(TAG);// Used to TAG the worker thread, important only for debugging.
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (!resultId.equals(lastResultId)) {
            ...
            PendingIntent pi=PendingIntent.getActivities(this,0, new Intent[]{new Intent(this, PhotoGalleryActivity.class)},0);
